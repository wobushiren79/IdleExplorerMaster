...
public class GroundHexagonsBean : BaseBean
{
    ...
    public AreaDiscoveryStatusEnum groundDiscoveryStatus { get => EnumUtil.GetEnum<AreaDiscoveryStatusEnum>(m_AreaDiscoveryStatus); set => m_AreaDiscoveryStatus = (int)value; }
